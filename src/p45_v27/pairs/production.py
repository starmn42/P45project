...
from .lifecycle_v12 import build_official_prediction_audit, restore_lifecycle_gate_data
...
class ProductionPairPipeline:
    ...
    def build_prediction_context(self, evaluation_round: int, source_end_round: int,
        ...
        for candidate in candidates:
            ...
            gate_data = restore_lifecycle_gate_data(gate_data, rank, past, len(valid_rows))
