...
- 1239 prospective sealed original: `UNCHANGED`, 현재 `PENDING`.
...
- Research Master: `E:\P45 프로젝트\90_RESEARCH\P45_RESEARCH_MASTER_INDEX_002.md`
...
- 기존 연구 여부는 Master 002에서 먼저 확인하고 실제 판정은 원본 Result/locked protocol로 확인한다.
