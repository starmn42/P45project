...
- valid_for_pair: 12
- PAIR: PAIR_BOOTSTRAP_PATCH_OFFICIAL / NOT_APPROVED
- 다음 허용 작업: 공식 Bootstrap PATCH 기준으로 PAIR WALKFORWARD fail-fast preflight 재실행
...
- 마지막 decision_id: DECISION-20260810-025
