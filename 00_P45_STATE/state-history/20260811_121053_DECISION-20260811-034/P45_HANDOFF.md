...
- valid_for_pair: 12
- PAIR: PAIR_SIGNATURE_EXPOSURE_STARVATION / NOT_APPROVED
- 다음 허용 작업: PAIR v1.1 signature granularity 공식 규칙 완전성 검토 및 payload auditability 보완안 설계
...
- 마지막 decision_id: DECISION-20260811-034
