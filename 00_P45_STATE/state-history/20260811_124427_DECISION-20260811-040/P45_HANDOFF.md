...
- valid_for_pair: 12
- PAIR: PAIR_GATE_TIMING_REVISION_REQUIRED / NOT_APPROVED
- 다음 허용 작업: PG05/PG14 prelock payload와 final prediction payload의 분리 또는 결정론적 two-phase 평가 순서를 공식 선택
...
- 마지막 decision_id: DECISION-20260811-040
