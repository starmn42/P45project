...
- valid_for_pair: 12
- PAIR: PAIR_GATE_TIMING_PATCH_OFFICIAL / NOT_APPROVED
- 다음 허용 작업: 공식 Timing PATCH를 source of truth로 사용해 중단된 15-key·PG descriptor와 exact Context DRAFT 보완
...
- 마지막 decision_id: DECISION-20260811-041
