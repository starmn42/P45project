...
- valid_for_pair: 12
- PAIR: PAIR_WALKFORWARD_CONFLICT / NOT_APPROVED
- 다음 허용 작업: PAIR WALKFORWARD gate/state context 누락 수정 및 기존 completed run 처리 방안 승인
...
- 마지막 decision_id: DECISION-20260810-032
